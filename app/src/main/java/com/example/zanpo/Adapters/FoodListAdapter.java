...
public class FoodListAdapter extends ArrayAdapter<FoodItem> {
    ...
    public FoodListAdapter(@NonNull Context context, ArrayList<FoodItem> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItem == null) listItem = LayoutInflater.from(mContext).inflate(R.layout.food_item, parent, false);
